...
cont = journaliste.length
bgn = 0
until bgn == cont
        @restClient.update("#{journaliste[bgn]} Élève à THP", in_reply_to_status_id: journaliste[bgn])
      bgn += 1
end
